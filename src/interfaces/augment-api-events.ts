...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      AssetRegistered: AugmentedEvent<ApiType, [u128, MoonbeamRuntimeAssetType, MoonbeamRuntimeAssetRegistrarMetadata]>;
      /**
       ...
       **/
      SupportedAssetRemoved: AugmentedEvent<ApiType, [MoonbeamRuntimeAssetType]>;
      /**
    ...
    assets: {
       ...
       **/
      TransferredApproved: AugmentedEvent<ApiType, [u128, AccountId20, AccountId20, AccountId20, u128]>;
    };
    authorFilter: {
      /**
    ...
    xcmTransactor: {
       ...
       **/
      TransactInfoChanged: AugmentedEvent<ApiType, [XcmV1MultiLocation, XcmTransactorRemoteTransactInfoWithMaxWeight]>;
    };
    xTokens: {
      /**
       * Transferred.
       **/
      Transferred: AugmentedEvent<ApiType, [AccountId20, MoonbeamRuntimeCurrencyId, u128, XcmV1MultiLocation]>;
      /**
       * Transferred `MultiAsset`.
       **/
      TransferredMultiAsset: AugmentedEvent<ApiType, [AccountId20, XcmV1MultiAsset, XcmV1MultiLocation]>;
      /**
       * Transferred `MultiAsset` with fee.
       **/
      TransferredMultiAssets: AugmentedEvent<ApiType, [AccountId20, XcmV1MultiassetMultiAssets, XcmV1MultiLocation]>;
      /**
       * Transferred `MultiAsset` with fee.
       **/
      TransferredMultiAssetWithFee: AugmentedEvent<ApiType, [AccountId20, XcmV1MultiAsset, XcmV1MultiAsset, XcmV1MultiLocation]>;
      /**
       * Transferred `MultiAsset` with fee.
       **/
      TransferredMultiCurrencies: AugmentedEvent<ApiType, [AccountId20, Vec<ITuple<[MoonbeamRuntimeCurrencyId, u128]>>, XcmV1MultiLocation]>;
      /**
       * Transferred with fee.
       **/
      TransferredWithFee: AugmentedEvent<ApiType, [AccountId20, MoonbeamRuntimeCurrencyId, u128, u128, XcmV1MultiLocation]>;
    };
  } // AugmentedEvents
} // declare module
