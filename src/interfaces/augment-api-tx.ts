...
import type { CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportScheduleMaybeHashed, MoonbeamRuntimeAssetRegistrarMetadata, MoonbeamRuntimeAssetType, MoonbeamRuntimeCurrencyId, MoonbeamRuntimeOriginCaller, MoonbeamRuntimeProxyType, MoonbeamRuntimeTransactors, NimbusPrimitivesNimbusCryptoPublic, PalletAssetsDestroyWitness, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, ParachainStakingInflationRangePerbill, ParachainStakingInflationRangeU128, SpRuntimeMultiSignature, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       * assetType
       **/
      changeExistingAssetType: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, newAssetType: MoonbeamRuntimeAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, MoonbeamRuntimeAssetType, u32]>;
      /**
       * Register new asset with the asset manager
       **/
      registerAsset: AugmentedSubmittable<(asset: MoonbeamRuntimeAssetType | { Xcm: any } | string | Uint8Array, metadata: MoonbeamRuntimeAssetRegistrarMetadata | { name?: any; symbol?: any; decimals?: any; isFrozen?: any } | string | Uint8Array, minAmount: u128 | AnyNumber | Uint8Array, isSufficient: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeAssetType, MoonbeamRuntimeAssetRegistrarMetadata, u128, bool]>;
      /**
       * Remove a given assetType from the supported assets for fee payment
       **/
      removeSupportedAsset: AugmentedSubmittable<(assetType: MoonbeamRuntimeAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeAssetType, u32]>;
      /**
       * Change the amount of units we are charging per execution second for a given AssetType
       **/
      setAssetUnitsPerSecond: AugmentedSubmittable<(assetType: MoonbeamRuntimeAssetType | { Xcm: any } | string | Uint8Array, unitsPerSecond: u128 | AnyNumber | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeAssetType, u128, u32]>;
    };
    assets: {
      /**
    ...
    authorFilter: {
       ...
       **/
      setEligible: AugmentedSubmittable<(updated: Percent | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Percent]>;
    };
    authorInherent: {
      /**
    ...
    balances: {
       ...
       **/
      setBalance: AugmentedSubmittable<(who: AccountId20 | string | Uint8Array, newFree: Compact<u128> | AnyNumber | Uint8Array, newReserved: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Compact<u128>, Compact<u128>]>;
      /**
    ...
    councilCollective: {
       ...
       * # </weight>
       **/
      setMembers: AugmentedSubmittable<(newMembers: Vec<AccountId20> | (AccountId20 | string | Uint8Array)[], prime: Option<AccountId20> | null | object | string | Uint8Array, oldCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<AccountId20>, Option<AccountId20>, u32]>;
      /**
    ...
    crowdloanRewards: {
       ...
       **/
      initializeRewardVec: AugmentedSubmittable<(rewards: Vec<ITuple<[U8aFixed, Option<AccountId20>, u128]>> | ([U8aFixed | string | Uint8Array, Option<AccountId20> | null | object | string | Uint8Array, u128 | AnyNumber | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[U8aFixed, Option<AccountId20>, u128]>>]>;
      /**
    ...
    democracy: {
       ...
       **/
      delegate: AugmentedSubmittable<(to: AccountId20 | string | Uint8Array, conviction: PalletDemocracyConviction | 'None' | 'Locked1x' | 'Locked2x' | 'Locked3x' | 'Locked4x' | 'Locked5x' | 'Locked6x' | number | Uint8Array, balance: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, PalletDemocracyConviction, u128]>;
      /**
       ...
       **/
      removeOtherVote: AugmentedSubmittable<(target: AccountId20 | string | Uint8Array, index: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u32]>;
      /**
       * Remove a vote for a referendum.
       * 
       * If:
       ...
       **/
      unlock: AugmentedSubmittable<(target: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
    ...
    identity: {
       ...
       * # </weight>
       **/
      provideJudgement: AugmentedSubmittable<(regIndex: Compact<u32> | AnyNumber | Uint8Array, target: AccountId20 | string | Uint8Array, judgement: PalletIdentityJudgement | { Unknown: any } | { FeePaid: any } | { Reasonable: any } | { KnownGood: any } | { OutOfDate: any } | { LowQuality: any } | { Erroneous: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u32>, AccountId20, PalletIdentityJudgement]>;
      /**
    ...
    parachainStaking: {
       ...
       **/
      executeLeaveDelegators: AugmentedSubmittable<(delegator: AccountId20 | string | Uint8Array, delegationCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u32]>;
      /**
       ...
       **/
      hotfixRemoveDelegationRequests: AugmentedSubmittable<(delegators: Vec<AccountId20> | (AccountId20 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId20>]>;
      /**
       ...
       **/
      hotfixUpdateCandidatePoolValue: AugmentedSubmittable<(candidates: Vec<AccountId20> | (AccountId20 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId20>]>;
      /**
       ...
       **/
      setInflation: AugmentedSubmittable<(schedule: ParachainStakingInflationRangePerbill | { min?: any; ideal?: any; max?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ParachainStakingInflationRangePerbill]>;
      /**
       ...
       **/
      setStakingExpectations: AugmentedSubmittable<(expectations: ParachainStakingInflationRangeU128 | { min?: any; ideal?: any; max?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ParachainStakingInflationRangeU128]>;
      /**
    ...
    proxy: {
       ...
       * # </weight>
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbeamRuntimeProxyType, u32]>;
      /**
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      killAnonymous: AugmentedSubmittable<(spawner: AccountId20 | string | Uint8Array, proxyType: MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbeamRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbeamRuntimeProxyType> | null | object | string | Uint8Array, call: Call | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonbeamRuntimeProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbeamRuntimeProxyType> | null | object | string | Uint8Array, call: Call | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, Option<MoonbeamRuntimeProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbeamRuntimeProxyType, u32]>;
    };
    scheduler: {
      /**
    ...
    treasury: {
       ...
       * # </weight>
       **/
      proposeSpend: AugmentedSubmittable<(value: Compact<u128> | AnyNumber | Uint8Array, beneficiary: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: MoonbeamRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { CouncilCollective: any } | { TechCommitteeCollective: any } | { CumulusXcm: any } | { PolkadotXcm: any } | string | Uint8Array, call: Call | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeOriginCaller, Call]>;
    };
    xcmTransactor: {
      /**
       ...
       **/
      setTransactInfo: AugmentedSubmittable<(location: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, transactExtraWeight: u64 | AnyNumber | Uint8Array, feePerSecond: u128 | AnyNumber | Uint8Array, maxWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation, u64, u128, u64]>;
      /**
       ...
       **/
      transactThroughDerivative: AugmentedSubmittable<(dest: MoonbeamRuntimeTransactors | 'Relay' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, currencyId: MoonbeamRuntimeCurrencyId | { SelfReserve: any } | { OtherReserve: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array, innerCall: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeTransactors, u16, MoonbeamRuntimeCurrencyId, u64, Bytes]>;
      /**
       * Transact the inner call through a derivative account in a destination chain,
       ...
       * to be a reserve asset for the destination transactor::multilocation.
       **/
      transactThroughDerivativeMultilocation: AugmentedSubmittable<(dest: MoonbeamRuntimeTransactors | 'Relay' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, feeLocation: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array, innerCall: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeTransactors, u16, XcmVersionedMultiLocation, u64, Bytes]>;
      /**
       ...
       **/
      transactThroughSovereign: AugmentedSubmittable<(dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, feePayer: AccountId20 | string | Uint8Array, feeLocation: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array, call: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation, AccountId20, XcmVersionedMultiLocation, u64, Bytes]>;
    };
    xTokens: {
      /**
       ...
       * messages correctly.
       **/
      transferMulticurrencies: AugmentedSubmittable<(currencies: Vec<ITuple<[MoonbeamRuntimeCurrencyId, u128]>> | ([MoonbeamRuntimeCurrencyId | { SelfReserve: any } | { OtherReserve: any } | string | Uint8Array, u128 | AnyNumber | Uint8Array])[], feeItem: u32 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[MoonbeamRuntimeCurrencyId, u128]>>, u32, XcmVersionedMultiLocation, u64]>;
      /**
